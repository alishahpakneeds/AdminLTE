...
<html>
    ...
    <body class="skin-blue">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="../UI/modals.html"><i class="fa fa-angle-double-right"></i> Modals</a></li>
                            </ul>
                        </li>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown">Action 1 <span class="fa fa-caret-down"></span></button>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <div class="form-group">
        ...
        <script src="../../dist/js/bootstrap-filestyle.min.js" type="text/javascript"></script>
    </body>
</html>